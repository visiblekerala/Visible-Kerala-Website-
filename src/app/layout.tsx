  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Anek+Malayalam:wght@400;500;600;700;800&family=Baloo+2:wght@600;700;800&family=Baloo+Chettan+2:wght@600;700;800&family=Gayathri:wght@400;700&family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@500;600;700;800&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
